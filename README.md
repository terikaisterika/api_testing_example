...
<p>10.Подключение по ws://127.0.0.1:7001 Можно запустить второе подключение через ws://127.0.0.1:7001 и отправлять сообщения, чтобы посмотреть, как это работает.</p>
<p>11.Можно воспользоваться командами взаимодействия с сервером. (описаны выше)</p>
<p><strong>P.S: </strong>вообще не уверена, что это кому-то понадобится -_- </p>
